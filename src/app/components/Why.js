        ...
        <section className="section flex items-center" id="why">
            <div className='container mx-auto'>
                ...
                className='max-w-[680px] text-center mx-auto mb-2'>
                    Our dedication to providing exception services sets us apart from the competition. From the moment you engage with us, we strive to exceed your expectations in every interaction.
                </motion.p>
                {/* car image*/}
                <motion.div 
                ...
                className='hidden md:flex justify-center mb-6 xl:mb-2'>
                    <Image src={'/images/why/car01.png'} width={1060} height={420} alt=''/>
                </motion.div>
                {/* grid items*/}
                <motion.div
                ...
                className='flex flex-wrap justify-center xl:grid xl:grid-cols-3 gap-4 xl:gap-y-0 xl:gap-x-[30px]'>
                    ...
                    <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
                        ...
                        <p className='hidden xl:flex'>We priotize your need and we go above and beyond to ensure your expeirnece with us in noting short of outstanding.</p>
                    </div>
                    {/* item 2 */}
                    <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
